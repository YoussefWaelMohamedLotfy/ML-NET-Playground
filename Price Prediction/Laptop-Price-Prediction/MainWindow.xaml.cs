...
using static PricePredictionModel_Console.PricePredictionModel;

namespace Laptop_Price_Prediction;
...
public partial class MainWindow : Window
{
        ...
        double weight)
    {
        ...
        ModelOutput result = PricePredictionModel_Console.PricePredictionModel.Predict(input);
        return result.Score;
    }
}
